...
train_save_path = "./train_results/train" # Train Result Path
val_save_path = "./train_results/val"    # Val Result Path
weight_save_path = "./train_results/weight"  # PG Weights Save Path
logger_save_path = "./train_results/"    # Logger Save Path
...
save_train_path_stargan = train_save_path + '/stargan'
save_val_path_stargan = val_save_path + '/stargan'
...
def path_isexists():
    ...
    if not os.path.exists(save_train_path_stargan):
        os.makedirs(save_train_path_stargan)
    if not os.path.exists(save_val_path_stargan):
        os.makedirs(save_val_path_stargan)
...
StarGAN_path = './checkpoints/stargan'